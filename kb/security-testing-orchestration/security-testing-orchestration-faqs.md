...
An enhancement has been made to ensure the orchestration step always downloads restuls for the branch specified in the step, instead of downloading results only for main or master branches.
